...
/**
 * Class TBD_Debug_Test_Helper_Performance
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 *
 * @covers TBD_Debug_Helper_Performance
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Helper_Performance extends EcomDev_PHPUnit_Test_Case
{
    /** @var TBD_Debug_Helper_Performance */
    protected $helper;

    protected function setUp()
    {
        $this->helper = Mage::helper('tbd_debug/performance');
    }
    ...
    public function testGetCategory()
    {
        ...
        $this->assertEquals('event_listener', $this->helper->getCategory('OBSERVER tbd_debug'));
    ...
    {
        $requestInfo = $this->getModelMock('tbd_debug/requestInfo', array('getToken', 'getTimers'));
