...
/**
 * Class TBD_Debug_Test_Helper_Filter
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 *
 * @covers TBD_Debug_Helper_Filter
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Helper_Filter extends EcomDev_PHPUnit_Test_Case
{
    /** @var TBD_Debug_Helper_Filter */
    protected $helper;

    protected function setUp()
    {
        $this->helper = Mage::helper('tbd_debug/filter');
    }
    ...
    public function testGetRequestFilters()
    {
        ...
        $helper = $this->getHelperMock('tbd_debug/filter', array('getFilterParams'));
