...
/**
 * Class TBD_Debug_Test_Model_Design
 *
 * @category TBD
 ...
 *
 * @covers TBD_Debug_Model_Design
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Model_Design extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        $this->model = Mage::getModel('tbd_debug/design');
    }
    ...
    public function testInit()
    {
        ...
        $layoutUpdate->expects($this->any())->method('getHandles')->willReturn(array('default', 'STORE_default', 'tbd_debug'));
        ...
        $this->assertContains('tbd_debug', $this->model->getLayoutHandles());
