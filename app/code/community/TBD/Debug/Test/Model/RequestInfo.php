...
/**
 * Class TBD_Debug_Test_Model_RequestInfo
 *
 * @category TBD
 ...
 *
 * @covers TBD_Debug_Model_RequestInfo
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Model_RequestInfo extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        $this->model = Mage::getModel('tbd_debug/requestInfo');
    }

    public function testConstruct()
    {
        $this->assertNotFalse($this->model);
        $this->assertInstanceOf('TBD_Debug_Model_RequestInfo', $this->model);
        $this->assertEquals('tbd_debug/requestInfo', $this->model->getResourceName());
        $this->assertNotNull($this->model->getDesign());
        $this->assertInstanceOf('TBD_Debug_Model_Design', $this->model->getDesign());
    }


    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo
     */
    public function testResource()
    {
        $resourceModel = $this->model->getResource();
        $this->assertNotFalse($resourceModel);
        $this->assertInstanceOf('TBD_Debug_Model_Resource_RequestInfo', $resourceModel);
        $this->assertEquals('tbd_debug_request_info', $resourceModel->getMainTable());
        $this->assertEquals('id', $resourceModel->getIdFieldName());
    }


    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection
     */
    public function testCollection()
    {
        $collection = $this->model->getCollection();
        $this->assertNotFalse($collection);
        $this->assertInstanceOf('TBD_Debug_Model_Resource_RequestInfo_Collection', $collection);
        $this->assertEquals('tbd_debug/requestInfo', $collection->getResourceModelName());
    }


    public function testInitLogging()
    {
        $helper = $this->getHelperMock('tbd_debug', array('getLogFilename', 'getExceptionLogFilename'));
        $this->replaceByMock('helper', 'tbd_debug', $helper);
        $helper->expects($this->any())->method('getLogFilename')->willReturn('tbd_system.log');
        $helper->expects($this->any())->method('getExceptionLogFilename')->willReturn('tbd_exception.log');

        $logging = $this->getModelMock('tbd_debug/logging', array('addFile', 'startRequest'));
        $this->replaceByMock('model', 'tbd_debug/logging', $logging);
        $logging->expects($this->at(0))->method('addFile')->with('tbd_system.log');
        $logging->expects($this->at(1))->method('addFile')->with('tbd_exception.log');
        $logging->expects($this->once())->method('startRequest');

        $this->model->initLogging();
        $this->assertEventDispatched('tbd_debug_init_logging');
    }
    ...
    {
        $this->model->addEmail(Mage::getModel('tbd_debug/email'));
    ...
    public function testAddControllerAction()
    {
        ...
        $controllerMock = $this->getModelMock('tbd_debug/controller', array('init'));
        $controllerMock->expects($this->once())->method('init')->with($action);
        $this->replaceByMock('model', 'tbd_debug/controller', $controllerMock);

        $this->model->addControllerAction($action);

        $actual = $this->model->getController();
        $this->assertNotNull($actual);
        $this->assertInstanceOf('TBD_Debug_Model_Controller', $actual);
    }
    ...
    public function testAddLayout()
    {
        ...
        $design = $this->getModelMock('tbd_debug/design', array('init'));
        $design->expects($this->once())->method('init')->with($layout, $designPackage);

        $model = $this->getModelMock('tbd_debug/requestInfo', array('getDesign'));
    ...
    {
        $b1 = $this->getModelMock('tbd_debug/block',
        ...
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getBlocks'));
    ...
    {
        $collectionMock = $this->getModelMock('tbd_debug/collection', array('incrementCount', 'init', 'getClass'));
        ...
        $this->replaceByMock('model', 'tbd_debug/collection', $collectionMock);
    ...
    {
        $col1 = $this->getModelMock('tbd_debug/collection', array('getType', 'getClass', 'getQuery', 'getCount'));
        ...
        $col2 = $this->getModelMock('tbd_debug/collection', array('getType', 'getClass', 'getQuery', 'getCount'));
        ...
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getCollections'));
    ...
    {
        $modelMock = $this->getModelMock('tbd_debug/model', array('init', 'getClass', 'incrementCount'));
        ...
        $this->replaceByMock('model', 'tbd_debug/model', $modelMock);
    ...
    {
        $model1 = $this->getModelMock('tbd_debug/model', array('getResource', 'getClass', 'getCount'));
        ...
        $model2 = $this->getModelMock('tbd_debug/model', array('getResource', 'getClass', 'getCount'));
        ...
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getModels'));
    ...
    public function testInitQueries()
    {
        ...
        $helperMock = $this->getHelperMock('tbd_debug', array('getSqlProfiler'));
        $helperMock->expects($this->any())->method('getSqlProfiler')->willReturn($profilerMock);
        $this->replaceByMock('helper', 'tbd_debug', $helperMock);

        $model = $this->getModelMock('tbd_debug/requestInfo', array('setQueryCount', 'setQueryTime'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug', array('getMemoryUsage'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug', array('getCurrentScriptDuration'));
    ...
    {
        TBD_Debug_Model_Block::$endRenderingTime = 0.90;
        TBD_Debug_Model_Block::$startRenderingTime = 0.75;
    ...
    {
        $controller = $this->getModelMock('tbd_debug/controller', array('getSessionId'));
        $controller->expects($this->any())->method('getSessionId')->willReturn(12345);

        $model = $this->getModelMock('tbd_debug/requestInfo', array('getController'));
    ...
    {
        $model = $this->getModelMock('tbd_debug/requestInfo',
    ...
    {
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getInfo'));
    ...
    public function testGetAbsoluteUrl()
    {
        ...
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getStoreId', 'getRequestPath'));
    ...
    {
        $controller = $this->getModelMock('tbd_debug/controller',
        ...
        $this->assertEventDispatched('tbd_debug_requestInfo_save_before');
    }
    ...
    public function testAfterLoad()
    {
        ...
        $model = $this->getModelMock('tbd_debug/requestInfo', array('getUnserializedInfo'));
        ...
        $this->assertEventDispatched('tbd_debug_requestInfo_load_after');
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addSessionIdFilter
     */
    public function testAddSessionIdFilter()
    {
        $collection = $this->getResourceModelMock('tbd_debug/requestInfo_collection', array('addFieldToFilter'));
        $this->replaceByMock('resource_model', 'tbd_debug/requestInfo_collection', $collection);
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addTokenFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addHttpMethodFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addRequestPathFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addResponseCodeFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addIpFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addEarlierFilter
     */
    ...
    /**
     * @covers TBD_Debug_Model_Resource_RequestInfo_Collection::addAfterFilter
     */
