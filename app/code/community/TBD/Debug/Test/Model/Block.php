...
/**
 * Class TBD_Debug_Test_Model_Block
 *
 * @category TBD
 ...
 *
 * @covers TBD_Debug_Model_Block
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Model_Block extends EcomDev_PHPUnit_Test_Case
{

    public function testConstruct()
    {
        $model = Mage::getModel('tbd_debug/block');

        $this->assertNotFalse($model);
        $this->assertInstanceOf('TBD_Debug_Model_Block', $model);
    }
    ...
    public function testInit()
    {
        ...
        $model = $this->getModelMock('tbd_debug/block', array('startRendering'), false, array(), '', false);
        $model->init($block);
    ...
    public function testStartRenderingTwice()
    {
        ...
        /** @var TBD_Debug_Model_Block $model */
        $model = $this->getModelMock('tbd_debug/block', array('init'), false, array(), '', false);
