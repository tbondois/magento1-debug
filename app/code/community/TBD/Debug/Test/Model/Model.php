...
/**
 * Class TBD_Debug_Test_Model_Model
 *
 * @category TBD
 ...
 *
 * @covers TBD_Debug_Model_Model
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Model_Model extends EcomDev_PHPUnit_Test_Case
{

    public function testConstruct()
    {
        $model = Mage::getModel('tbd_debug/model');
        $this->assertNotFalse($model);
        $this->assertInstanceOf('TBD_Debug_Model_Model', $model);
    }
