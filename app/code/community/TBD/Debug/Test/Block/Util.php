...
/**
 * Class TBD_Debug_Test_Block_Util
 *
 * @category TBD
 ...
 *
 * @covers TBD_Debug_Block_Util
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Block_Util extends EcomDev_PHPUnit_Test_Case
{

    public function testFlushCacheUrl()
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getFlushCacheUrl'));
        $helper->expects($this->once())->method('getFlushCacheUrl')->willReturn('cache flush url');
        $this->replaceByMock('helper', 'tbd_debug/url', $helper);

        $block = $this->getBlockMock('tbd_debug/util', array('toHtml'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getDisableTemplateHintsUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getEnableFPCDebugUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getDisableFPCDebugUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getEnableTranslateUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getDisableTranslateUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug', array('canEnableVarienProfiler'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getEnableSqlProfilerUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getDisableSqlProfilerUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getEnableVarienProfilerUrl'));
    ...
    {
        $helper = $this->getHelperMock('tbd_debug/url', array('getDisableVarienProfilerUrl'));
