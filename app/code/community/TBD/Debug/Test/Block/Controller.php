...
/**
 * Class TBD_Debug_Test_Block_Controller
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 *
 * @covers TBD_Debug_Block_Controller
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Block_Controller extends EcomDev_PHPUnit_Test_Case
{

    public function testGetController()
    {
        $controller = $this->getModelMock('tbd_debug/controller', array('getResponseCode'), false, array(), '', false);
        ...
        $block = $this->getBlockMock('tbd_debug/controller', array('getRequestInfo'));
    ...
    public function testGetResponseCode()
    {
        ...
        $block = $this->getBlockMock('tbd_debug/controller', array('getController', 'getAction'));
    ...
    {
        $block = $this->getBlockMock('tbd_debug/controller', array('getResponseCode'));
