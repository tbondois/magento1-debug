...
/**
 * Class TBD_Debug_Test_Block_View_Sidebar
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 *
 * @covers TBD_Debug_Block_View_Sidebar
 * @codeCoverageIgnore
 */
class TBD_Debug_Test_Block_View_Sidebar extends EcomDev_PHPUnit_Test_Case
{

    public function testGetHttpMethodOptions()
    {
        $helper = $this->getHelperMock('tbd_debug/filter', array('getHttpMethodValues'));
        ...
        $block = $this->getBlockMock('tbd_debug/view_sidebar', array('getOptionArray'));
    ...
    public function testGetHttpMethodsSelect()
    {
        ...
        $block = $this->getBlockMock('tbd_debug/view_sidebar', array('getHttpMethodOptions', 'getLayout', 'getRequest'));
    ...
    public function testGetLimitOptionsSelect()
    {
        ...
        $block = $this->getBlockMock('tbd_debug/view_sidebar', array('getOptionArray', 'getLayout', 'getRequest'));
