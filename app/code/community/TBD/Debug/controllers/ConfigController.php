...
/**
 * Class TBD_Debug_ConfigController
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 */
class TBD_Debug_ConfigController extends TBD_Debug_Controller_Front_Action
{
    /**
     * PHP info Action
     */
    ...
    {
        $items = array();
        Mage::helper('tbd_debug')->xml2array($configNode, $items);
