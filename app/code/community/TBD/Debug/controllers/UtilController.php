...
/**
 * Class TBD_Debug_UtilController
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 */
class TBD_Debug_UtilController extends TBD_Debug_Controller_Front_Action
{
    ...
    public function searchGroupClassAction()
    {
        ...
        if ($uri) {
            ...
            $block = $this->getLayout()->createBlock('tbd_debug/array');
            $block->setTemplate('tbd_debug/grouped_class_search.phtml');
