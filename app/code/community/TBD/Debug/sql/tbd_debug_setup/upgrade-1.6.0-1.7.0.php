...
$table = $installer->getConnection()
    ->newTable($installer->getTable('tbd_debug/request_info'))
    ...
    ->addIndex($this->getIdxName('tbd_debug/request_info', array('token')), array('token'))
    ->addIndex($this->getIdxName('tbd_debug/request_info', array('session_id')), array('session_id'))
    ->addIndex($this->getIdxName('tbd_debug/request_info', array('request_path')), array('request_path'));
