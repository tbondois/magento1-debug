...
/**
 * Class TBD_Debug_Model_Core_Email_Template rewrites core/email_template class in order
 ...
 */
trait TBD_Debug_Model_Core_Email_Template_Capture
{
    ...
    {
        $emailCapture = Mage::getModel('tbd_debug/email');
        ...
        Mage::getSingleton('tbd_debug/observer')->getRequestInfo()->addEmail($emailCapture);
    }
...
if (Mage::helper('core')->isModuleEnabled('Aschroder_SMTPPro')) {
    ...
    class TBD_Debug_Model_Core_Email_Template extends Aschroder_SMTPPro_Model_Email_Template
    {
        use TBD_Debug_Model_Core_Email_Template_Capture;
    }

} else if(Mage::helper('core')->isModuleEnabled('Ebizmarts_Mandrill')) {


    class TBD_Debug_Model_Core_Email_Template extends Ebizmarts_Mandrill_Model_Email_Template
    {
        use TBD_Debug_Model_Core_Email_Template_Capture;
    }
    ...
    class TBD_Debug_Model_Core_Email_Template extends Mage_Core_Model_Email_Template
    {
        use TBD_Debug_Model_Core_Email_Template_Capture;
    }
}
