...
/**
 * Class TBD_Debug_Model_RequestInfo
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 * @method TBD_Debug_Model_RequestInfo setToken(string $value)
 * @method string getHttpMethod()
 * @method TBD_Debug_Model_RequestInfo setHttpMethod(string $value)
 * @method int getStoreId()
 * @method TBD_Debug_Model_RequestInfo setStoreId(int $value)
 * @method string getRequestPath()
 * @method TBD_Debug_Model_RequestInfo setRequestPath(string $value)
 * @method int getResponseCode()
 * @method TBD_Debug_Model_RequestInfo setResponseCode(int $value)
 * @method string getIp()
 * @method TBD_Debug_Model_RequestInfo setIp(string $value)
 * @method string getSessionId()
 * @method TBD_Debug_Model_RequestInfo setSessionId(string $value)
 * @method string getDate()
 * @method TBD_Debug_Model_RequestInfo setDate(string $value)
 * @method TBD_Debug_Model_RequestInfo setRenderingTime(float $value)
 * @method float getQueryTime()
 * @method TBD_Debug_Model_RequestInfo setQueryTime(float $value)
 * @method int getQueryCount()
 * @method TBD_Debug_Model_RequestInfo setQueryCount(int $value)
 * @method TBD_Debug_Model_RequestInfo setTime(float $value)
 * @method TBD_Debug_Model_RequestInfo setPeakMemory(int $value)
 * @method  getInfo()
 * @method TBD_Debug_Model_RequestInfo setInfo($value)
 */
class TBD_Debug_Model_RequestInfo extends Mage_Core_Model_Abstract
{
    /** @var TBD_Debug_Model_Logging */
    protected $logging;

    /** @var TBD_Debug_Model_Controller */
    protected $action;

    /** @var TBD_Debug_Model_Design */
    protected $design;

    /** @var TBD_Debug_Model_Block[] */
    protected $blocks = array();

    /** @var TBD_Debug_Model_Model[] */
    protected $models = array();

    /** @var TBD_Debug_Model_Collection[] */
    ...
    public function initLogging()
    {
        ...
        $this->logging = Mage::getModel('tbd_debug/logging');
        ...
        Mage::dispatchEvent('tbd_debug_init_logging', array('logging' => $this->logging));
     ...
     *
     * @param TBD_Debug_Model_Email $email
     */
    public function addEmail(TBD_Debug_Model_Email $email)
    {
        $this->emails[] = $email;
    }
     ...
     * @return TBD_Debug_Model_Block
     */
    public function addBlock(Mage_Core_Block_Abstract $block)
    {
        $blockInfo = Mage::getModel('tbd_debug/block');
    ...
    {
        $info = Mage::getModel('tbd_debug/collection');
     ...
     *
     * @return TBD_Debug_Model_Collection[]
     */
    ...
    {
        $modelInfo = Mage::getModel('tbd_debug/model');
    ...
    public function initQueries()
    {
        ...
        $profiler = Mage::helper('tbd_debug')->getSqlProfiler();
    ...
    {
        return $this->hasData('peak_memory') ? $this->getData('peak_memory') : Mage::helper('tbd_debug')->getMemoryUsage();
    }
    ...
    {
        return $this->hasData('time') ? $this->getData('time') : Mage::helper('tbd_debug')->getCurrentScriptDuration();
    }
    ...
    {
        return $this->hasData('rendering_time') ? $this->getData('rendering_time') : TBD_Debug_Model_Block::getTotalRenderingTime();
    }


    protected $_eventPrefix = 'tbd_debug_requestInfo';


    protected function _construct()
    {
        $this->_init('tbd_debug/requestInfo');
        $this->design = Mage::getModel('tbd_debug/design');
    }
