 ...
 */
class TBD_Debug_Helper_Data extends Mage_Core_Helper_Data
{
    const DEBUG_OPTIONS_ENABLE_PATH = 'tbd_debug/options/enable';
    const DEBUG_OPTION_PERSIST_PATH = 'tbd_debug/options/persist';
    const DEBUG_OPTION_PERSIST_EXPIRATION_PATH = 'tbd_debug/options/persist_expiration';
    const DEBUG_OPTION_FORCE_VARIEN_PROFILE_PATH = 'tbd_debug/options/force_varien_profile';
    ...
    /**
     * Returns module name (e.g TBD_Debug)
     *
     * @return string
     */
    ...
    {
        return !$this->isTBDDebugRequest($this->_getRequest()) && $this->canShowToolbar();
    }
     ...
     * @return bool
     */
    public function isTBDDebugRequest(Mage_Core_Controller_Request_Http $request)
    {
        return strpos($request->getPathInfo(), '/tbd_debug/') === 0;
    }
     ...
     * @see TBD_Debug_Model_Model
     *
     * @param TBD_Debug_Model_Model|TBD_Debug_Model_Collection $a
     * @param TBD_Debug_Model_Model|TBD_Debug_Model_Collection $b
     * @return int
     */
    ...
    {
        usort($objects, array('TBD_Debug_Helper_Data', 'sortModelCmp'));
    }
