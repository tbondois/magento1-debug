 ...
 */
class TBD_Debug_Helper_Url extends Mage_Core_Helper_Data
{
    const MODULE_ROUTE = 'tbd_debug/';
    ...
    {
        //@fixes : try to get current store instead of return Mage::app()->getDefaultStoreView()->getId();
        try {
     ...
     *
     * @see \TBD_Debug_IndexController::searchAction
     * @param array $filters
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_IndexController::latestAction
     * @param string $panel
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_IndexController::viewAction
     * @param $token
     * @param string $panel
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ModuleController::enableAction
     ...
     *
     * @see \TBD_Debug_ModuleController::disableAction
     * @param string $moduleName
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ModelController::enableSqlProfilerAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ModelController::disableSqlProfilerAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ModelController::selectSqlAction
     * @param string $token
     * @param int $index
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ModelController::describeSqlAction
     * @param string $token
     * @param int $index
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_DesignController::layoutUpdatesAction
     * @param string $token
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_IndexController::viewLogAction
     * @param string $token
     ...
     *
     * @see \TBD_Debug_IndexController::purgeProfilesAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::searchGroupClassAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::flushCacheAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::enableTemplateHintsAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::disableTemplateHintsAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::enableFPCDebugAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::disableFPCDebugAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::enableTranslateAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_UtilController::disableTranslateAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ConfigController::phpinfoAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ConfigController::searchAction
     ...
     *
     * @see \TBD_Debug_ConfigController::downloadAction
     * @param string $type
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ConfigController::enableVarienProfilerAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_ConfigController::disableVarienProfilerAction
     * @return string
     */
     ...
     *
     * @see \TBD_Debug_EmailController::getBodyAction
     * @param string $token
     * @param int $row
     * @return string
     */
