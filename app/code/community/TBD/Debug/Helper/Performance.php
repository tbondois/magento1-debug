...
/**
 * Class TBD_Debug_Helper_Performance
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 */
class TBD_Debug_Helper_Performance extends Mage_Core_Helper_Abstract
{
     ...
     *
     * @param TBD_Debug_Model_RequestInfo $request
     * @return array
     */
    public function convertTimers(TBD_Debug_Model_RequestInfo $request)
    {
