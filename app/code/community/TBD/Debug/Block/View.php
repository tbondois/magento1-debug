...
/**
 * Class TBD_Debug_Block_View represents main block used in request profile view page
 *
 * @category TBD
 * @package  TBD_Debug
 ...
 */
class TBD_Debug_Block_View extends TBD_Debug_Block_Abstract
{
    ...
    public function getRequestInfo()
    {
        if ($this->requestInfo === null) {
            $this->requestInfo = Mage::registry('tbd_debug_request_info');
        }
    ...
    {
        return Mage::getSingleton('tbd_debug/service');
    }
    ...
    public function getFilteredRequestListUrl($filters = array())
    {
        ...
        $currentFilters = Mage::helper('tbd_debug/filter')->getRequestFilters($this->getRequest());
    ...
    public function renderArray($data, $noDataLabel = 'No Data', $header = null)
    {
        ...
        $block->setTemplate('tbd_debug/view/panel/_array.phtml');
    ...
    public function renderArrayFields(array $data, array $fields = array(), $noDataLabel = 'No Data')
    {
        ...
        /** @var Mage_Core_Block_Template $block */
        $block = $this->getLayout()->createBlock('tbd_debug/view');
        $block->setTemplate('tbd_debug/view/panel/_array_fields.phtml');
        $block->setData('array', $data);
     ...
     *
     * @see TBD_Debug_Block_View::getBlocksTree
    ...
    public function renderTreeNode(Varien_Data_Tree_Node $node, $indentLevel=0)
    {
        ...
        $block->setTemplate('tbd_debug/view/panel/_block_node.phtml');
        $block->setNode($node);
